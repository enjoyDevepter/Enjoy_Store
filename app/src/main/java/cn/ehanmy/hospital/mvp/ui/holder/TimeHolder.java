 ...
 * ================================================
 */
public class TimeHolder extends BaseHolder<ReservationTimeBean> {
    ...
    @Override
    public void setData(ReservationTimeBean category, int position) {
        Observable.just(category.getTime()).subscribe(new Consumer<String>() {
            @Override
            public void accept(String s) throws Exception {
                nameTV.setText(category.getTime());
            }
        });
        Observable.just(category.isChoose()).subscribe(new Consumer<Boolean>() {
            @Override
