...
import cn.ehanmy.hospital.di.component.DaggerHGoodsListComponent;
...
import cn.ehanmy.hospital.mvp.presenter.HGoodsListPresenter;
...
public class HGoodsListActivity extends BaseActivity<HGoodsListPresenter> implements HGoodsListContract.View, View.OnClickListener, DefaultAdapter.OnRecyclerViewItemClickListener, TabLayout.OnTabSelectedListener, SwipeRefreshLayout.OnRefreshListener, GoodsListAdapter.OnChildItemClickLinstener {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerHGoodsListComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .hGoodsListModule(new HGoodsListModule(this))
                .build()
                .inject(this);
    }
    ...
    public void onChildItemClick(View v, GoodsListAdapter.ViewName viewname, int position) {
        switch (viewname) {
            case BUY:
            case ITEM:
                Intent intent = new Intent(ArmsUtils.getContext(), HGoodsConfirmActivity.class);
