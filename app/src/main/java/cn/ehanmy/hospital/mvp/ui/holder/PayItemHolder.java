 ...
 * ================================================
 */
public class PayItemHolder extends BaseHolder<PayEntry> {
    ...
    @Override
    public void setData(PayEntry data, int position) {
        ...
        try {
            mImageLoader.loadImage(itemView.getContext(),
                    ImageConfigImpl
                            ...
                            .url(new JSONObject(data.getExtendParams()).optString("url"))
                            .isCenterCrop(true)
                            .imageView(mImage)
                            .build());
